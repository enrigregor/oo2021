...
public static void main(String[] args) {
    ...
    List<Character> characters = Arrays.asList('a', 'b', 'b');
    ...
    SimplePair<Integer, String> pair = new SimplePair<>(5, "võti");
    ...
    System.out.println(
        Generics.getType(1) + " " +
        Generics.getType("Sõna") + " " +
        Generics.getType(2.0) + " " +
        Generics.getType('c')
    );

    String[] stringArray = {"Hello", "World", "this", "is", "me"};
